...
![Tests](https://img.shields.io/badge/tests-169%2F169-brightgreen)
...
169 tests côté Mac, tous sur les moteurs purs (scores, zones,
...
├── HealthCheckTests/    # 169 tests (moteurs + store + mapping + synchro compagnon + entraînement)

...
| Toute distance de séance passe par `WorkoutStatsEngine.distanceKilometres` | l'export mêle les unités — 1 303 séances en km, 26 nages **en mètres** ; lire `totalDistance` brut annoncerait un 1 500 m comme « 1 500 km ». Défaut latent jusqu'au premier réimport : les seules distances déjà en base venaient de la synchro, que `HKMapper` convertit en km |
